...
public class PlanetToolsInspector : Editor
{
    ...
    private TileHex LastHilightedTile;
    ...
    private List<TileHex> AppliedActionTiles = new List<TileHex>();
    ...
    private void OnSceneGUI()
    {
        ...
        else if(IsEditing)
        {
            ...
            foreach(TileHex lastT in LastHilightedTiles)
            {
    ...
    List<TileHex> LastHilightedTiles = new List<TileHex>();
    ...
    void RaycastSelect()
    {
        ...
        {
            TileHex t = hit.collider.gameObject.GetComponent<TileHex>();
            if (t != null)
            {
    ...
    void CircleSelect()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            if (t != null)
            {
                ...
                {
                    TileHex ti = tCollider.GetComponent<TileHex>();
                ...
                if (MouseIsDown)
                {
                    foreach(TileHex hilighted in LastHilightedTiles)
                    {
        ...
        {
            foreach(TileHex t in LastHilightedTiles)
            {
    ...
    void ApplyToolAction(TileHex t)
    {
